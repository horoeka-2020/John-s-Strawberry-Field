  ...
  Autumn: [
    {
      ...
      name: 'Broccoli',
      type: 'vegetable',
      planting: 'Bursting with goodness, these hardy no fuss vegetables are brilliant crops to plant in the winter garden. This superfood is jam-packed with valuable nutrients and minerals. The best times to plant are early in the morning or late in the day, so the plants aren’t exposed to the hot sun straight away. Always water plants well before and after planting. ',
      image: '/broccoli.jpg'
    },
    {
      id: 14,
      ...
      type: 'vegetable',
      planting: 'Bursting with goodness, these hardy no fuss vegetables are brilliant crops to plant in the winter garden. Adored by many yet loathed by others, Brussels sprouts are one of the easiest and most rewarding vegetables to grow. Bad childhood memories of being forced to eat overcooked Brussels sprouts will be banished once you grow and cook your own! Brussels sprouts are the perfect crop for areas with cold winters, as the lower temperatures generally result in sweeter sprouts. What’s more they produce a bumper yield for the amount of space they take up in the garden. Harvested in the cooler months of the year, they are the perfect staple crop for winter and spring.',
    ...
    },
    {
      ...
      name: 'Pears',
      type: 'fruit',
      planting: 'Choose an open, sunny position sheltered from strong winds for your pear tree. Pears are partially self-fertile. Prepare your soil with organic matter like compost and sheep pellets.',
      image: '/pears.jpg'
    },
    {
      id: 17,
      name: 'Chrysanthemum',
      type: 'flower',
      planting: 'Chrysanthemums are susceptible to mildew, so keeping the plants dry is a priority. They need plenty of air circulation, water drainage, and morning sun to dry the dew on the leaves and stems.',
    ...
    },
    {
      ...
      name: 'Aster',
      type: 'flower',
      planting: 'Asters grow best in full sun. They will handle partial shade but flowering will be less-prolific. To avoid the likelihood of powdery mildew affecting plants ensure a sunny, open position with good airflow.',
      image: ''
    },
  ],
  Winter: [
    {
      ...
      name: 'Kale',
      type: 'vegetable',
      planting: 'The best times to plant are early in the morning or late in the day, so the plants aren’t exposed to the hot sun straight away. Find a full sun, sheltered position to plant and space at least 30cm - 50cm apart, to ensure the crops can fully mature and are not fighting for space, fertiliser and water.',
      image: '/kale.jpg'
    },
    {
      id: 20,
      name: 'Carrots',
      type: 'vegetable',
      planting: 'Sow seed for the winter carrot crop in mid-summer, and deep mulch the bed in November with shredded leaves or straw. This insulating layer should be topped with an old row cover or bed sheet to hold it in place.',
      image: '/carrots.jpg'
    },
    {
      id: 21,
      name: 'Strawberries',
      type: 'fruit',
      planting: 'There are three main types. Plant June-bearing for one big crop in late spring or early summer, everbearing for spring and fall crops, and day-neutral for a large crop in spring and smaller harvests all summer.',
    ...
    },
    {
      ...
      name: 'Peaches',
      type: 'fruit',
      planting: 'Plant trees against a southfacing wall under an eave, and prune them into a fan shape. And if you’re short on space, plant three or four varieties in one hole, pruning off all but the outwardfacing branches.',
      image: '/peaches.jpg'
    },
    {
      id: 23,
      name: 'Pansies',
      type: 'flower',
      planting: 'Pansies like full or partial sun, but need cooler temperatures to thrive. The ideal planting site will get morning sun but avoid the heat of the late afternoon.',
      image: '/pansies.jpg'
    },
    {
      id: 24,
      name: 'Hellebores',
      type: 'flower',
      planting: 'Hellebores prefer to grow in rich well-drained soil in full to part shade and whilst they are shade lovers most do better with a little sun, under the canopy of a deciduous tree or shrub is an ideal location.',
